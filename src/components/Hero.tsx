  ...
  return (
    ...
    >
      ...
      <div style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', maxWidth: 900 }}>
        ...
        {/* Eyebrow pill */}
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: 10, padding: '6px 18px', borderRadius: 100, marginBottom: 28, background: 'rgba(91,53,213,.12)', border: '1px solid rgba(91,53,213,.25)', fontSize: 12, fontWeight: 600, letterSpacing: '.08em', textTransform: 'uppercase', color: 'rgba(255,255,255,.75)', animation: 'fadeUp .9s both' }}>
          <div style={{ width: 6, height: 6, background: '#10B981', borderRadius: '50%', boxShadow: '0 0 8px #10B981', animation: 'pulse 2s infinite' }} />
          Africa Premier ICT Partner
        </div>
