      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p style={{ fontSize: '1rem', color: '#4A3F6B', maxWidth: 620, margin: '0 auto 48px', lineHeight: 1.8 }}>
            FlowTech offers custom software developed to suit a company's goals, needs, and requirements. We emphasize adaptability, secure design, ease of integration and automation, and ongoing support.
          </p>
        </motion.div>
        ...
        {visibleCount > 0 && !allVisible && (
          <div style={{ marginBottom: 32, display: 'flex', alignItems: 'center', gap: 12 }}>
            <div style={{ flex: 1, height: 3, background: 'rgba(91,53,213,0.1)', borderRadius: 100, overflow: 'hidden' }}>
              <motion.div
                animate={{ width: (visibleCount / SERVICES.length * 100) + '%' }}
        ...
        {/* Bottom banner — only shows after all cards revealed */}
        {allVisible && (
          <motion.div
            initial={{ opacity: 0, y: 24 }}
          ...
          >
            <div>
              <div style={{ fontFamily: 'Cabinet Grotesk, sans-serif', fontSize: '1.2rem', fontWeight: 900, color: 'white', marginBottom: 6, letterSpacing: '-.02em' }}>
                We have structured our company to provide both business-solutions and services-solutions
              </div>
              <div style={{ fontSize: 13, color: 'rgba(255,255,255,.6)', lineHeight: 1.6 }}>
                From strategy through deployment — one trusted partner for your entire digital journey.
              </div>
            </div>
