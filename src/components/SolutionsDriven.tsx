...
const SOLUTIONS = [
  {
    icon: <Code size={24} />,
    color: '#5B35D5',
    title: 'Software Development & Business Solutions',
    desc: 'Delivering secure, adaptable, and tailor-made software solutions designed to streamline operations, automate workflows, and drive innovation.',
    tags: ['Custom Software', 'Automation', 'Integration', 'Secure Design'],
  },
  {
    icon: <Lightbulb size={24} />,
    color: '#E8401A',
    title: 'Consulting Services',
    desc: 'Guiding businesses with over 20 years of expertise in process design, change management, and strategic consulting to unlock growth and efficiency.',
    tags: ['Process Design', 'Change Management', 'Strategy', 'Growth'],
  },
  {
    icon: <GraduationCap size={24} />,
    color: '#0EA5E9',
    title: 'Training Services',
    desc: 'Empowering teams through customized training programs that blend theory with practice, enabling staff to work smarter, faster, and more effectively.',
    tags: ['Team Training', 'Theory & Practice', 'Upskilling', 'Enablement'],
  },
  {
    icon: <HeadphonesIcon size={24} />,
    color: '#10B981',
    title: 'Support',
    desc: 'Providing proactive IT support and ongoing assistance to ensure business continuity, minimize downtime, and keep systems running at peak performance.',
    tags: ['Proactive Support', 'Business Continuity', 'Uptime', 'Assistance'],
  },
]
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            {[
              ...
              { step: '03', label: 'Deliver & support long-term',  color: '#10B981' },
              ...
              >
                <div style={{ width: 40, height: 40, borderRadius: 12, background: color + '15', border: '1px solid ' + color + '25', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'JetBrains Mono, monospace', fontSize: 12, fontWeight: 700, color, flexShrink: 0 }}>
                  {step}
                </div>
                <div style={{ fontSize: 14, fontWeight: 600, color: '#0D0720', fontFamily: 'Cabinet Grotesk, sans-serif' }}>
                  {label}
                </div>
        ...
        {visibleCount > 0 && !allVisible && (
          <div style={{ marginBottom: 32, display: 'flex', alignItems: 'center', gap: 12 }}>
            <div style={{ flex: 1, height: 3, background: 'rgba(91,53,213,0.1)', borderRadius: 100, overflow: 'hidden' }}>
              <motion.div
                animate={{ width: (visibleCount / SOLUTIONS.length * 100) + '%' }}
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(280px,1fr))', gap: 20 }}>
          {SOLUTIONS.map(({ icon, color, title, desc, tags }, i) => (
            ...
            >
              ...
              <div style={{ fontFamily: 'Cabinet Grotesk, sans-serif', fontSize: '1.05rem', fontWeight: 800, color: '#0D0720', marginBottom: 10, letterSpacing: '-.01em', lineHeight: 1.3 }}>
                {title}
              </div>
              <div style={{ fontSize: '.88rem', color: '#4A3F6B', lineHeight: 1.75, marginBottom: 18 }}>
                {desc}
              </div>
              <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap', marginBottom: 18 }}>
                {tags.map(t => (
                  <span key={t} style={{ fontSize: 10, padding: '3px 10px', background: color + '10', border: '1px solid ' + color + '22', borderRadius: 100, color, fontFamily: 'JetBrains Mono, monospace', fontWeight: 600 }}>
                    {t}
                  </span>
                ))}
              </div>
        ...
        {allVisible && (
          ...
          >
            <div>
              <div style={{ fontFamily: 'Cabinet Grotesk, sans-serif', fontSize: '1.2rem', fontWeight: 900, color: 'white', marginBottom: 6, letterSpacing: '-.02em' }}>
                Ready to find the right solution for your business?
              </div>
              <div style={{ fontSize: 13, color: 'rgba(255,255,255,.6)', lineHeight: 1.6 }}>
                Let us understand your requirements first — then we will propose what fits best.
              </div>
            </div>
